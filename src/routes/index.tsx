...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Drop 5 lbs in 72 Hours — Free Keto Reset" },
      {
        name: "description",
        content:
          "A simple day-by-day keto reset. Drop your first 5 lbs in 72 hours. Free instant access — no email, no payment.",
      },
      { property: "og:title", content: "Drop 5 lbs in 72 Hours" },
      {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-gradient-hero">
        <div className="mx-auto max-w-[820px] px-5 py-12 text-center sm:py-16">
          ...
          <h1 className="mt-6 text-balance text-4xl font-black uppercase leading-[1.02] tracking-tight sm:text-5xl lg:text-6xl">
            Drop Your First <span className="text-primary">5 lbs In 72 Hours</span> — For People Who've Tried Before And Are Done With Slow Results.
          </h1>
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            A simple day-by-day keto reset designed for anyone who's tried before and failed. Fast results. No starving. No confusion.
          </p>
          <a
            href={ctaLink}
            className="mt-8 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-cta px-6 py-4 text-base font-extrabold uppercase tracking-wide text-cta-foreground shadow-cta transition-transform duration-200 animate-pulse-glow hover:scale-[1.02] active:scale-[0.98] sm:w-auto sm:text-lg"
          >
      ...
      <section className="border-y border-border/60 bg-card/40">
        <div className="mx-auto grid max-w-[820px] gap-3 px-5 py-5 text-sm font-semibold sm:grid-cols-3 sm:text-base">
          <div className="flex items-center justify-center gap-2">
            <Check className="h-4 w-4 text-primary" /> 4,200+ downloads this week
          </div>
          <div className="flex items-center justify-center gap-2">
      ...
      <section className="mx-auto max-w-[820px] px-5 py-14 sm:py-20">
        <h2 className="text-center text-3xl font-black uppercase tracking-tight sm:text-4xl">
          Why Most People <span className="text-primary">Fail Keto</span>
        </h2>
      ...
      <section className="bg-card/30 py-14 sm:py-20">
        <div className="mx-auto max-w-[820px] px-5">
          <h2 className="text-center text-3xl font-black uppercase tracking-tight sm:text-4xl">
            The <span className="text-primary">72-Hour</span> Keto Reset
          </h2>
          <div className="mt-10 rounded-3xl border-2 border-primary/60 bg-gradient-card p-7 shadow-glow animate-border-glow sm:p-9">
            ...
            <ul className="space-y-3">
              {[
                "Day-by-day meal plan built around real metabolism",
        ...
        <div className="mx-auto max-w-[820px] px-5">
          ...
          <div className="mt-10 space-y-4">
            {[
              ...
              { name: "Sarah L.", quote: "The Day 2 trick saved me. Never made it past Day 2 before this. Down 6 lbs and counting." },
      ...
      <section className="px-5 py-14 sm:py-20">
        <div className="mx-auto max-w-[820px] rounded-3xl border-2 border-primary bg-gradient-card p-8 text-center shadow-glow-strong sm:p-12">
          ...
          <a
            href={ctaLink}
            className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-cta px-6 py-5 text-base font-black uppercase tracking-wide text-cta-foreground shadow-cta-strong transition-transform duration-200 animate-pulse-glow hover:scale-[1.03] active:scale-[0.98] sm:w-auto sm:px-10 sm:text-lg"
          >
